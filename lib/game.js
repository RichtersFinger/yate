											...
											if (thiscarddata.length === 4) {
												...
												var addcardfunction = (function (somedeckid, somecarddata){
																return function(){
																	...
																	var newcard = new Card(somedeckid, ++cardcounter, decks[somedeckid], gamediv, InitialMouseDownX + cardcounter * Math.min(1*somecarddata[0], 1*somecarddata[1])/words.length, InitialMouseDownY + cardcounter * Math.min(1*somecarddata[0], 1*somecarddata[1])/words.length, 1*somecarddata[0], 1*somecarddata[1], somecarddata[2], somecarddata[3]);
