...
var relevantdata_timerframe = ["id", "owner", "viewingrights", "timestamp", "x", "y", "timer_duration", "streamposition", "fixposition", "animated", "playsfx", "sfxfile", "sfxvolume", "autorestart", "lotterylink", "showlabel", "scale", "zIndex"];
var relevantdata_timerframe_types = {"id":"number", "owner":"numberarray", "viewingrights":"numberarray", "timestamp":"number", "x":"number", "y":"number", "timer_duration":"number" , "streamposition":"boolean", "fixposition":"boolean", "animated":"boolean", "playsfx":"boolean", "sfxfile":"string", "sfxvolume":"number", "autorestart":"boolean", "lotterylink":"number", "showlabel":"boolean", "scale":"number", "zIndex":"number"};
	...
	iosocket.on('playsound', ( somesound, looping, somevolumemultiplier ) => {
	    ...
	    .done(function() {
 			...
 			if (looping) {
 				...
 				audio_loop.pause();
				console.log(somevolumemultiplier);
 				if (somevolumemultiplier)
