...
class CanvasFrameContainer {
			...
			if (this.owner.includes(player)) {
				if (e.target === this.thisdiv || e.target === this.fabriccanvas.upperCanvasEl || e.target === this.controlsdiv) {
					if (this.drawingmode === "") {
						...
						this.brushcolordiv.style.backgroundColor = this.brushcolorinput1.value;
	...
	//	this.controlsredobutton.style.border = "2px solid #FFFFFF";
		...
		this.brushcolorlabeldivcontainer = document.createElement('div');
		this.brushcolordiv = document.createElement('div');
		this.brushcolordiv.style.width = "10px";
		this.brushcolordiv.style.height = "10px";
		this.brushcolordiv.style.backgroundColor = "#ff0000";
		this.brushcolordiv.style.borderColor = "#ffffff";
		this.brushcolordiv.style.borderStyle = "solid";
		this.brushcolordiv.style.borderWidth = "1px";
		this.brushcolordiv.style.display = "inline-block";
		this.brushcolorlabel = document.createElement('label');
		this.brushcolorlabel.style.display = "inline-block";
		...
		var changebrushcolor1 = (function (canvasreference){
						return function(){
						   canvasreference.brushcolordiv.style.backgroundColor = canvasreference.brushcolorinput1.value;
		...
		var changebrushcolor2 = (function (canvasreference){
						return function(){
						   canvasreference.brushcolordiv.style.backgroundColor = canvasreference.brushcolorinput2.value;
		...
		var changebrushcolor3 = (function (canvasreference){
						return function(){
						   canvasreference.brushcolordiv.style.backgroundColor = canvasreference.brushcolorinput3.value;
		...
		var changebrushcolor4 = (function (canvasreference){
						return function(){
						   canvasreference.brushcolordiv.style.backgroundColor = canvasreference.brushcolorinput4.value;
		...
		var changebrushcolor5 = (function (canvasreference){
						return function(){
						   canvasreference.brushcolordiv.style.backgroundColor = canvasreference.brushcolorinput5.value;
		...
		var changebrushcolor6 = (function (canvasreference){
						return function(){
						   canvasreference.brushcolordiv.style.backgroundColor = canvasreference.brushcolorinput6.value;
		...
		this.controlsdiv.appendChild(document.createElement('br'));
		this.brushcolorlabeldivcontainer.appendChild(this.brushcolorlabel);
		this.brushcolorlabeldivcontainer.appendChild(this.brushcolordiv);
		this.controlsdiv.appendChild(this.brushcolorlabeldivcontainer);
		//this.controlsdiv.appendChild(document.createElement('br'));
		...
		this.canvascontainer = document.getElementById("somecanvas"+someid).parentElement;
...
//		this.fabriccanvas.preserveObjectStacking = true;
	...
	setdisplayposition() {
		...
		this.thisdiv.style.left = this.displayx + "px";
		this.thisdiv.style.top = this.displayy + "px";
		var offsetx = Math.min(0, this.scale * zoomvalue * this.x - cameraposx);
		var offsety = Math.min(0, this.scale * zoomvalue * this.y - cameraposy);
		if (-offsetx + this.fabriccanvas.getWidth() > this.displaywidth)
			offsetx = this.fabriccanvas.getWidth() - this.displaywidth;
		if (-offsety + this.fabriccanvas.getHeight() > this.displayheight)
			offsety = this.fabriccanvas.getHeight() - this.displayheight;
		this.canvascontainer.style.left = -offsetx + "px";
		this.canvascontainer.style.top = -offsety + "px";
	...
	setdisplayscale() {
		...
		var offsetx = Math.min(0, this.scale * zoomvalue * this.x - cameraposx);
		var offsety = Math.min(0, this.scale * zoomvalue * this.y - cameraposy);
		this.fabriccanvas.setWidth(Math.min(1.1 * window.innerWidth, this.displaywidth + 0));
		this.fabriccanvas.setHeight(Math.min(1.1 * window.innerHeight, this.displayheight + 0));
