...
class Card {
	constructor(somedeckid, somecardid, somedeck, parentdiv, x0, y0, w0, h0, frontfilename, backfilename) {
		...
		if (this.width < this.height) {
			this.thishandicon.style.width = Math.min(this.displaywidth, Math.max(handiconscale*this.displaywidth, Math.min(this.displaywidth, 50)))+"px";
			this.thishandicon.style.height = Math.min(this.displaywidth, Math.max(handiconscale*this.displaywidth, Math.min(this.displaywidth, 50)))+"px";
		} else {
			this.thishandicon.style.width = Math.min(this.displayheight, Math.max(handiconscale*this.displayheight, Math.min(this.displayheight, 50)))+"px";
			this.thishandicon.style.height = Math.min(this.displayheight, Math.max(handiconscale*this.displayheight, Math.min(this.displayheight, 50)))+"px";
		}
	}
	draw() {
